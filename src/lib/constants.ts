...
export const MAIN_NAVIGATION: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Birmingham', href: '/local/birmingham' },
      { label: 'Leeds', href: '/local/leeds' },
      { label: 'Liverpool', href: '/local/liverpool' },
      { label: 'Bristol', href: '/local/bristol' },
      { label: 'Sheffield', href: '/local/sheffield' },
      { label: 'Newcastle', href: '/local/newcastle' },
      { label: 'Nottingham', href: '/local/nottingham' },
      { label: 'Leicester', href: '/local/leicester' },
      { label: 'Hackney', href: '/local/hackney' },
    ],
  },
  {
    label: 'Costs & Funding',
