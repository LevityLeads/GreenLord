        ...
        <Container>
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <article className="flex-1 max-w-4xl">
              ...
              {/* Hero Image */}
              <ImagePlaceholder
                alt="Energy efficient home improvements funded by Warm Homes Local Grant"
                description="A rental property receiving comprehensive energy efficiency upgrades - could show installers fitting insulation, new windows being installed, or heat pump equipment being delivered. Should convey significant, whole-house improvement funded by the scheme."
                width={1200}
                height={630}
                instructions={[
                  'Show multiple improvement types happening',
                  'Professional installers at work',
                  'Typical UK rental property setting',
                  'Convey comprehensive, whole-house approach',
                ]}
                priority
              />
